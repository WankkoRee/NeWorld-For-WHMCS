...
$_LANG['affiliatesrealtime'] = "此处将实时统计更新";
...
$_LANG['affiliateswithdrawn'] = "提现总额";
$_LANG['all'] = "共";
...
$_LANG['cartexistingclientlogindesc'] = "要添加此订单到您现有的帐户，您需要登录：";
...
$_LANG['clientareaerroremail'] = "您没有输入邮件地址";
...
$_LANG['knowledgebaseArticleRatingThanks'] = "感谢您为我们提交文章";
$_LANG['language'] = "选择语言";
$_LANG['latefee'] = "滞纳金";
...
$_LANG['loginintrotext'] = "访问此页您必须先登录！注意：客户中心的账户和密码与空间控制面板的用户名和密码不同.";
...
$_LANG['maxmind_rejectemail'] = "我们不允许您用该电子邮件订购，请用其它的邮件地址再试一次。";
$_LANG['maxmind_title'] = "MaxMind";//无需翻译本条目
$_LANG['more'] = "更多";
$_LANG['morechoices'] = "更多选择";
$_LANG['networkissuesaffecting'] = "影响";
$_LANG['networkissuesaffectingyourservers'] = "请注意:被影响的服务器上有您的账户，将用金色的背景高亮显示";
...
$_LANG['ordererroruserexists'] = "该邮件地址已经被注册";
...
$_LANG['orderPromoCodePlaceholder'] = "如果您有优惠码，请输入";
...
$_LANG['ssladmininfodetails'] = "以下联络资料将不会显示在证书上 - 它是只用于本订单联系您。这个SSL证书和未来更新提醒我们将发送到以下指定的邮件地址。";
...
$_LANG['sslcsr'] = "CSR";
$_LANG['sslerrorapproveremail'] = "你必须选择一个审批的邮件地址";
...
$_LANG['supportticketspagetitle'] = "我的工单";
...
$_LANG['supportticketsstatusonhold'] = "请等待";
$_LANG['supportticketsstatusopen'] = "开启的";
...
$_LANG['supportticketclosedmsg'] = "工单已关闭，您可以重新开启它";
...
$_LANG['transferdomaindesc'] = "想转移域名到我们这儿？请在下面输入域名来开始转移。";
...
$_LANG['affiliatescommissionspending'] = "待确认";
$_LANG['affiliatescommissionsavailable'] = "有效佣金";
...
$_LANG['cartregisterdomainchoice'] = "我没有域名，我需要注册一个新域名";
$_LANG['carttransferdomainchoice'] = "我需要把在其他地方注册的域名转移到这里";
$_LANG['cartexistingdomainchoice'] = "我不需要注册新域名，我将把已有域名解析到这里";
...
$_LANG['cartavailableaddons'] = "增值服务";
...
$_LANG['clientareanavcontacts'] = "子帐户信息";
...
$_LANG['pwstrengthweak'] = "安全强度太弱";
$_LANG['pwstrengthmoderate'] = "安全强度一般";
...
$_LANG['affiliatesignuptitle'] = "拉到客户，向我们索取报酬";
$_LANG['affiliatesignupintro'] = "激活您的会员账户，并开始赚钱...";
$_LANG['affiliatesignupinfo1'] = "通过您的链接购买的空间，我们都将支付您佣金.";
$_LANG['affiliatesignupinfo2'] = "我们跟踪您的访客是指使用Cookie，所以就算您的用户没有立即购买，您也会在他购买后收到佣金。Cookie有效期为90天。";
...
$_LANG['domainaddonsemailforwardinginfo'] = "获取邮件转发到您所选择的替代邮件地址，以便您可以监视所有从一个单一账户。";
...
$_LANG['feedbackclosed'] = "反馈已关闭，不能提供反馈";
$_LANG['feedbackprovided'] = "您已经反馈过了";
$_LANG['feedbackthankyou'] = "我们感谢您抽出宝贵的时间提供反馈.";
$_LANG['feedbackreceived'] = "提交收稿";
$_LANG['feedbackdesc'] = "我们可以请求您花片刻的时间来填写下面的表单，与我们的技术支持团队的质量您的经验.";
$_LANG['feedbackclickreview'] = "点击这里查看提交的反馈";
$_LANG['feedbackopenedat'] = "开在";
$_LANG['feedbacklastreplied'] = "最后回答";
$_LANG['feedbackstaffinvolved'] = "工作人员";
$_LANG['feedbacktotalduration'] = "总持续时间";
$_LANG['feedbackpleaserate1'] = "请在（1-10）中选择一个";
...
$_LANG['twofa2ndfactorincorrect'] = "二次认证失败，请重试";
$_LANG['twofabackupcodereset'] = "通过备用代码登录成功<br />备用代码是一次性的，它将被重置";
$_LANG['twofacantaccess2ndfactor'] = "无法访问二次验证设备？";
$_LANG['twofaloginusingbackupcode'] = "用备用代码登录";
...
$_LANG['domaincontactdetails']['Company Name'] = "公司名称（个人请勿填写）";
$_LANG['domaincontactdetails']['Organisation Name'] = "组织名称（个人请勿填写）";
...
$_LANG['due'] = "由于";
$_LANG['affiliatessignups'] = "注册人数";
$_LANG['affiliatesconversionrate'] = "转换率";
$_LANG['affiliatesclicks'] = "访问数量";
$_LANG['contacts'] = "联系人";
...
$_LANG['orderForm']['checkout'] = "支付订单";
$_LANG['orderForm']['alreadyRegistered'] = "老客户请点此登录";
...
$_LANG['orderForm']['accountSecurity'] = "安全信息";
